...
//           vSelectStyle && typeof vSelectStyle === 'object'
//             ? css({ ...vSelectStyle }) + ' '
//             : ''
//         }${vIsIcon ? styled.menuItem + 'Icon ' : ''}${
//           styled.menuItemLink + '--level-' + level
...
// const NavigationContent = memo(({ menuItems = [], handles }: INavigation) => {
//   return (
...
// const ModalMobile = memo(
//   ({ isActive, setIsActive, classes, children }: IModalMobile) => (
//     <div
...
// const ContainerMobile = memo(({ children }: any) => {
